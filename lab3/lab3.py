...
# Name: David Yenicelik
# Email: david.yenicelik@gmail.com
...
def focused_evaluate(board):
    ...
    if board.is_game_over():
        ...
        score = board.longest_chain( board.get_current_player_id() ) * -1000
        #Guess this should be an easy but good measure of how deep a player is in the game
        #score = -1000
    else:
...
def alpha_beta_find_board_value(board, depth, eval_fn,
    ...
    """
    #How to exactly output alpha and beta values
